 ...
 <div class="pageheader">
    ...
    <div class="contentpanel">
        ...
        <div class="row">
            ...
            <div class="col-md-12">
                <form action="<%=request.getContextPath()%>/CategoryController" method="POST" id="wizard_validate"  class="form-horizontal">
                    ...
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                            <div class="form-group">
                                ...
                                <div class="col-sm-9">
                                    <input type="text"  name="Cat_name" id="cname" class="form-control" placeholder="Type category name..." required />
                                </div>
                            </div>
