 ...
 <div class="pageheader">
    ...
    <div class="contentpanel">
        ...
        <div class="row">
            ...
            <div class="col-md-12">
            <form action="<%=request.getContextPath() %>/TutorialController" method="POST" id="wizard_validate" class="form-horizontal">
<input type="hidden" name="mode" value="insert">                   
                    ...
                    <div class="panel panel-default">
                        <div class="panel-heading">
                            ...
                            <h4 class="panel-title">Add Tutorial</h4>
                            <%--<p>Please provide your name, email address (won't be published) and a comment.</p>--%>
                        </div>
                        <div class="panel-body">
                            <div class="form-group">
                                <label class="col-sm-3 control-label">Tutorail Name: <span class="asterisk">*</span></label>
                                <div class="col-sm-9">
                                    <input type="text"  name="T_name" id="cname" class="form-control" placeholder="Type Tuutorial name..." required />
                                </div>
                            </div>

                            <div class="form-group">
                                <label class="col-sm-3 control-label">Tutorial_Description: </label>
                                <div class="col-sm-9">
                                   <textarea class="form-control" name="T_desc"></textarea>
                                </div>
                            </div>
                                 <div class="form-group">
							   <iframe src="fileupload.jsp"  height="300" width="48.5%" style="margin-left: 34%"> </iframe>
								</div>
                        </div>
                        <!-- panel-body -->
