 ...
 <div class="pageheader">
    ...
    <div class="contentpanel">
        ...
        <div class="row">
            ...
            <div class="col-md-12">
            <form action="<%=request.getContextPath() %>/VideoController" method="POST" id="wizard_validate"  class="form-horizontal">
                    ...
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                            <div class="form-group">
                                <label class="col-sm-3 control-label">Video Name: <span class="asterisk">*</span></label>
                                <div class="col-sm-9">
                                    <input type="text"  name="V_name" id="cname" class="form-control" placeholder="Type Video name..." required />
                                </div>
                            </div>

                            <div class="form-group">
                                <label class="col-sm-3 control-label">Video_Description: </label>
                                <div class="col-sm-9">
