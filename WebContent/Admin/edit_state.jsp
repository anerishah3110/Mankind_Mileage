 ...
 <div class="pageheader">
    ...
    <div class="contentpanel">
        ...
        <div class="row">
            ...
            <div class="col-md-12">
           <form action="<%=request.getContextPath() %>/StateController" method="POST" class="form-horizontal">
           <z:forEach items="${sessionScope.lssearch }" var="j">
           <input type="hidden" name="flag" value="update">
<input type="hidden" name="state_ID" value="${j.state_id}" />
                    ...
                    <div class="panel panel-default">
                        ...
                        <div class="form-group">
									...
									<div class="col-sm-9">
										<select name="s_example" class="form-control">
                                <z:forEach items="${sessionScope.islist }" var="i">
                                	<z:if test="${i.country_id eq j.country_id.country_id }">
                                    <option value="${i.country_id }" selected="selected">${i.country_name }</option>
                                  </z:if>
                                  <z:if test="${i.country_id ne j.country_id.country_id }">
                            ...
                            <div class="form-group">
                                <label class="col-sm-3 control-label">State Name <span class="asterisk">*</span></label>
                                <div class="col-sm-9">
                                    <input type="text"  name="state_name" id="cname" value="${j.state_name }" class="form-control" placeholder="Type state name..." required />
                                </div>
                            </div>
