    ...
    <div class="contentpanel">
      ...
      <div class="panel panel-default">
        <div class="panel-heading">
          ...
          <h3 class="panel-title">Search City</h3>
              ...
              <tbody>
                 <c:forEach items="${sessionScope.lssearch }" var="i" varStatus="j">
                                <tr class="odd gradeX">
                                    ...
                                    <td>${j.count}</td>
                                    <td>${i.city_name }</td>
                                    <td><a href="<%=request.getContextPath() %>/CityController?flag=edit&&City_ID=${i.city_id}&&State_ID=${i.state_id.state_id}">Edit</a> / <a href="<%=request.getContextPath() %>/CityController?flag=delete&&City_ID=${i.city_id}">Delete</a></td>
