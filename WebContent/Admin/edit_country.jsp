 ...
 <div class="pageheader">
    ...
    <div class="contentpanel">
        ...
        <div class="row">
            ...
            <div class="col-md-12">
           <form action="<%=request.getContextPath() %>/CountryController" method="post" class="form-horizontal">
 <z:forEach items="${sessionScope.lssearch }" var="j">
<input type="hidden" name="flag" value="update">

<input type="hidden" name="c_id" value="${j.country_id}">
                    ...
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                            <div class="form-group">
                                ...
                                <div class="col-sm-9">
                                    <input type="text"  name="Country" value="${j.country_name }" id="cname" class="form-control" placeholder="Type country name..." required />
                                </div>
                            </div>
