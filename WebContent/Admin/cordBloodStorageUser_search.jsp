...
<div class="pageheader">
      ...
      <div class="breadcrumb-wrapper">
        ...
        <ol class="breadcrumb">
          ...
          <li class="active">Search CordBloodStorageUser</li>
        </ol>
      </div>
    </div>
    ...
    <div class="contentpanel">
      ...
      <div class="panel panel-default">
        <div class="panel-heading">
          ...
          <h3 class="panel-title">Search CordBloodStorageUser</h3>
                 ...
                 <c:forEach items="${sessionScope.lssearch }" var="i" varStatus="j">
                                ...
                                <tr class="odd gradeX">
                                   ...
                                   <td>  ${k.country_id.country_name }</td>
                                    ...
                                    <td>${k.email_id }</td>
                                    <td>${k.contact_no }</td>
                                    <td style="width: 100px;">${k.duedate }</td>
                                   <td>${k.hospital_name }</td>
                                    <td>${k.hospital_address}</td>
                                    <td>${k.docname }</td>
