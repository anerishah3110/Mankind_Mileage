...
<body>
 <div class="pageheader">
      <h2><i class="fa fa-home"></i> Manage Category <%--<span>Subtitle goes here...</span>--%></h2>
      <div class="breadcrumb-wrapper">
        <span class="label">You are here:</span>
        <ol class="breadcrumb">
          <li><a href="index.html">Manage catagory </a></li>
      ...
      <div class="row">
        ...
        <div class="col-md-12">
          <form action="<%=request.getContextPath() %>/CategoryController" method="POST" id="wizard_validate">
 <z:forEach items="${sessionScope.lssearch }" var="j">
 <input type="hidden" value="${j.category_id}" name="cat_id"/>
          ...
          <div class="panel panel-default">
              ...
              <div class="panel-body">
                <div class="form-group">
                  ...
                  <div class="col-sm-9">
                    <input type="text"  name="cat_name" id="cname" class="form-control" placeholder="Type category name..." value="${j.category_name}" required />
                  </div>
                </div>
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-9">
                  <textarea class="form-control" name="cat_desc">${j.category_description}</textarea>
                  </div>
                </div>
