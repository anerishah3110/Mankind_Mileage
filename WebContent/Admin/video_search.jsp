...
<div class="pageheader">
      ...
      <div class="breadcrumb-wrapper">
        ...
        <ol class="breadcrumb">
          ...
          <li class="active">Search Video</li>
        </ol>
      </div>
    </div>
        ...
        <div class="panel-body">
          ...
          <%@include file="errorNotify.jsp" %>
            <table class="table" id="table1">
              ...
              <tbody>
                 <c:forEach items="${sessionScope.myList }" var="i" varStatus="j">
                                <tr class="odd gradeX">
                                    
                                    <td>${j.count}</td>
                                    <td>${i.video_name }</td>
                                    <td>${i.video_desc }</td>
                                    <td><video controls><source src="<%=request.getContextPath() %>/doc/${i.video_path }"></video>
                                    
                                    </td>
                                    <td><a href="<%=request.getContextPath() %>/VideoController?mode=edit&&video_ID=${i.video_id}">Edit</a> / <a href="<%=request.getContextPath() %>/VideoController?mode=delete&&video_ID=${i.video_id}">Delete</a></td>
