    ...
    <div class="contentpanel">
      ...
      <div class="panel panel-default">
        <div class="panel-heading">
          ...
          <h3 class="panel-title">Search SubCategory</h3>
              ...
              <tbody>
                 <c:forEach items="${sessionScope.lssearch }" var="i" varStatus="j">
                                <tr class="odd gradeX">
                                    ...
                                    <td>${i.subcat_desc }</td>
                                    <td>${i.url }</td>
                                    <td><a href="<%=request.getContextPath() %>/SubcatController?flag=edit&subcat_id=${i.subcat_id }">Edit</a>  /   <a href="<%=request.getContextPath() %>/SubcatController?flag=delete&subcat_id=${i.subcat_id }">Delete</a></td>
                                    </tr>
                                    </c:forEach>
