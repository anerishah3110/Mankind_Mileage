...
<body>
 <div class="pageheader">
      <h2><i class="fa fa-home"></i> Manage New_feed <%--<span>Subtitle goes here...</span>--%></h2>
...
<input type="hidden" value="${j.event_id}" name="event_id"/>
          ...
          <div class="panel panel-default">
              ...
              <div class="panel-body">
                <div class="form-group">
                  <label class="col-sm-3 control-label">Edit Name <span class="asterisk">*</span></label>
                  <div class="col-sm-9">
                    <input type="text"  name="event_name"  value="${j.event_name}"id="cname" class="form-control" placeholder="Type event name..."  required />
                  </div>
                </div>
                
                <div class="form-group">
                  <label class="col-sm-3 control-label">Edit Description </label>
                  <div class="col-sm-9">
                  <textarea class="form-control" name="event_description">${j.event_description}</textarea>
                  </div>
                </div>
