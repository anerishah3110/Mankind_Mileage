...
//alert("Dharaaa"+xmlhttp.responseText);
			...
			//	alert("Dharaaa"+xmlhttp.responseText);
				...
				for(var i=0 ; i<jsonObj.length ; i++)
				{
					...
					document.nuwos.state_example.options.add(createOption);
	...
	{
		var removeState=document.nuwos.state_example.options.length;
		//alert(removeState);
		for(var i=removeState ; i>0 ; i-- )
		{
			//alert(document.cityForm.state_example.options[i].text);
			document.nuwos.state_example.remove(i);
		...
		xmlhttp.onreadystatechange = function() {
			if (xmlhttp.readyState == 4) {
				...
				for(var i=0 ; i<jsonObj.length ; i++)
				{
					...
					document.nuwos.city_example.options.add(createOption);
	...
	{
		var removeState=document.nuwos.city_example.options.length;
		//alert(removeState);
		for(var i=removeState ; i>0 ; i-- )
		{
			//alert(document.cityForm.state_example.options[i].text);
			document.nuwos.city_example.remove(i);
...
<div id="main">
		...
		<h2>NormalUser Registration</h2>

		<form method="post" onsubmit="return validate_password()" class="login" action="<%=request.getContextPath() %>/UserMasterController" name="nuwos">
		<input type="hidden" name="flag" value="insert">
		<input type="hidden" name="status" value="unblock">
		<input type="hidden" name="type" value="normal_noSibling">
