        ...
        .ready(
                function() {
                    ...
                    if ($(".scroll-mail").length > 0) {
                        $(".scroll-mail").height($(window).height() - 185)
                                .mCustomScrollbar({
                                    advanced : {
                                        autoScrollOnFocus : false
                                    }
                    ...
                    if ($(".accordion").length > 0) {
                        ...
                        $(".accordion .ui-accordion-header:last").css(
                                'border-bottom', '0px');
                    }
                    /* EOF Accordion */
                    ...
                    if ($("table.table10").length > 0)
                        $("table.table10").dataTable({
                            "iDisplayLength" : 5,
                            "aLengthMenu" : [ 5, 10, 25, 50, 100 ],
                            "sPaginationType" : "full_numbers",
                            "aoColumns" : [ {
                    ...
                    if ($("table.table7").length > 0)
                        $("table.table7").dataTable({
                            "iDisplayLength" : 5,
                            "aLengthMenu" : [ 5, 10, 25, 50, 100 ],
                            "sPaginationType" : "full_numbers",
                            "aoColumns" : [ {
                    ...
                    if ($("table.table15").length > 0)
                        $("table.table15").dataTable({
                            "iDisplayLength" : 5,
                            "aLengthMenu" : [ 5, 10, 25, 50, 100 ],
                            "sPaginationType" : "full_numbers",
                            "aoColumns" : [ {
                    ...
                    if ($("#validate").length > 0
                            || $("#validate_custom").length > 0)
                        $("#validate, #validate_custom").validationEngine(
                                'attach', {
                        ...
                        $('#wizard_validate').stepy(
                                {
                                    back : function(index) {
                                        ...
                                        // return false; //uncomment if u need
                                        // to validate on back click
                                    },
                                    next : function(index) {
                                        if (!$("#wizard_validate")
                    ...
                    if ($("input[class^='mask_']").length > 0) {
                        ...
                        $("input.mask_phone_ext").mask(
                                '99 (999) 999-9999? x99999');
                    ...
                    if ($("#price_rage").length > 0) {
                        ...
                        $("#price_amount").html(
                                "$" + $("#price_rage").slider("values", 0)
                                        + " - $"
                                        + $("#price_rage").slider("values", 1));
                    }
...
$(window).resize(
        function() {
            ...
            if ($(".scroll-mail").length > 0)
                $(".scroll-mail").height($(window).height() - 205)
                        .mCustomScrollbar('update');
