...
public class DonationDAO {
	...
	public void insert(DonationVO v){
	...
	public void update(String addr,String cno,String email,long id)
	{
		...
		String query = "update DonationVO set address='"+addr+"',contact_no='"+cno+"',email_id='"+email+"' where user_id='"+id+"'    ";
	...
	public List search()
	{
		...
		try
		{
			...
			Query q=session.createQuery("from DonationVO");
			ls=q.list();
	...
	public List search_p(String id)
	{
		...
		try
		{
			...
			Query q=session.createQuery("select email_id from DonationVO as d where d.user_id.user_id="+id1);
			ls=q.list();
