...
@WebServlet("/UploadServletPic")
public class UploadServletPic extends HttpServlet {
   
   private boolean isMultipart;
   private String filePath;
   private int maxFileSize = 30000 * 2024;
   ...
   public void doPost(HttpServletRequest request, 
      ...
      // Check that we have a file upload request
	   ...
	   System.out.println("filepathhhhhhhhh"+ filePath);
      ...
      /*Ends*/
      response.sendRedirect(request.getContextPath()+"/PhotoController?flag=insert");
   }catch(Exception ex) {
